...
const tabs = [
  { href: "/", label: "Invoices", Icon: IconCamera,
    match: (p: string) => p === "/" || (p.startsWith("/invoices") && p !== "/invoices/new") },
  { href: "/quotes", label: "Quotes", Icon: IconReceipt, match: (p: string) => p.startsWith("/quotes") },
  { href: "/customers", label: "Clients", Icon: IconUser, match: (p: string) => p.startsWith("/customers") },
  { href: "/settings", label: "Settings", Icon: IconSettings, match: (p: string) => p.startsWith("/settings") },
];
